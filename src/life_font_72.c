 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --bpp 4 --size 72 --no-compress --stride 1 --align 1 --font Montserrat-Bold.ttf --range 48-57 --format lvgl -o life_font_72.c
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t life_font_72 = {
#else
lv_font_t life_font_72 = {
#endif
